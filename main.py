...
if __name__ == "__main__":
    ...
    parser.add_argument("--facility-id", type=str, default="232507", help="Campground Facility ID")
    parser.add_argument("--campsite-id", type=str, default="", help="Campsite ID to hold")
    parser.add_argument("--start", type=str, default="2026-09-20", help="Start date YYYY-MM-DD")
    parser.add_argument("--end", type=str, default="2026-09-22", help="End date YYYY-MM-DD")
